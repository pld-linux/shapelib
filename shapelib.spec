...
%description -l pl
Biblioteka C Shapefile daje mo¿liwo¶æ pisania prostych programów w C
do odczytu, zapisu i uaktualniania (w pewnym zakresie) plików ESRI
oraz zwi±zanych z nimi plików atrybutów (.dbf).

%package devel
Summary:	Header files for shapelib library
Summary(pl):	Pliki nag³ówkowe biblioteki shapelib
...
Pliki nag³ówkowe biblioteki shapelib.
